...
#ifndef A2DP_VENDOR_LHDC_LL_H
#define A2DP_VENDOR_LHDC_LL_H

#include "a2dp_codec_api.h"
#include "a2dp_vendor_lhdc_constants.h"
#include "avdt_api.h"

class A2dpCodecConfigLhdcLL : public A2dpCodecConfig {
 public:
  A2dpCodecConfigLhdcLL(btav_a2dp_codec_priority_t codec_priority);
  virtual ~A2dpCodecConfigLhdcLL();
...
// false.
bool A2DP_VendorUsesRtpHeaderLhdcLL(bool content_protection_enabled,
                                  const uint8_t* p_codec_info);

// Gets the A2DP LHDC codec name for a given |p_codec_info|.
const char* A2DP_VendorCodecNameLhdcLL(const uint8_t* p_codec_info);
...
bool A2DP_VendorGetPacketTimestampLhdcLL(const uint8_t* p_codec_info,
...
// Returns true on success, otherwise false.
bool A2DP_VendorBuildCodecHeaderLhdcLL(const uint8_t* p_codec_info, BT_HDR* p_buf,
...
const char* A2DP_VendorCodecIndexStrLhdcLL(void);
