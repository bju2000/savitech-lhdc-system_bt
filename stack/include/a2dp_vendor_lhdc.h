...
class A2dpCodecConfigLhdc : public A2dpCodecConfig {
 public:
  A2dpCodecConfigLhdc(btav_a2dp_codec_priority_t codec_priority);
  virtual ~A2dpCodecConfigLhdc();
...
// false.
bool A2DP_VendorUsesRtpHeaderLhdc(bool content_protection_enabled,
                                  const uint8_t* p_codec_info);

// Gets the A2DP LHDC codec name for a given |p_codec_info|.
const char* A2DP_VendorCodecNameLhdc(const uint8_t* p_codec_info);
...
bool A2DP_VendorGetPacketTimestampLhdc(const uint8_t* p_codec_info,
